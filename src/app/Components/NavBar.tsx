    ...
    <nav className="w-64 bg-black p-8 border-r border-gray-800 text-white h-screen fixed left-0 top-0 flex flex-col overflow-y-auto">
      ...
      <div className="flex-1">
        <ul className="flex flex-col gap-6">
          <li>
            <Link href="/dashboard" className="flex items-center gap-4 hover:text-blue-400 transition-colors">
          ...
          <li>
            <Link href="/perfil" className="flex items-center gap-4 hover:text-blue-400 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-white">
          ...
          <li>
            <Link href="/Contactos" className="flex items-center gap-4 hover:text-blue-400 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-white">
          ...
          <li>
            <Link href="/negocios" className="flex items-center gap-4 hover:text-blue-400 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-white">
      ...
      <div className="border-t border-gray-700 pt-6 mt-8">
        <Link href="https://jacks21.netlify.app/" className="flex items-center gap-4 hover:text-green-400 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-white">
